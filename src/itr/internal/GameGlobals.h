...
inline INT32 *const g_recipeMenuCategoryPtr = (INT32 *)0x119FBF4;
...
inline void *GetInterfaceManager() { return *g_interfaceManagerPtr; }

inline void *GetTES() { return *g_tesPtr; }

inline void *GetModelLoader() { return *g_modelLoaderPtr; }

inline BGSDefaultObjectManager *GetDefaultObjectManager() { return *g_defaultObjectManagerPtr; }

inline void *GetCombatManager() { return *g_combatManagerPtr; }

inline void *GetDecalManager() { return *g_decalManagerPtr; }

inline void **GetFontManager() { return *g_fontManagerPtr; }

inline BSSpinLock *GetProcessListsActorLock() { return g_processListsActorLock; }

inline void *GetBSWin32Audio() { return *g_bsWin32AudioPtr; }

inline UINT32 GetMapMenuVoicePlaybackAudioFlags() { return *g_mapMenuVoicePlaybackAudioFlagsPtr; }

inline bool IsConsoleStateOpen() { return *g_consoleStatePtr != 0; }

inline void SetGodModeEnabled(bool enabled) { *g_godModeEnabledPtr = enabled ? 1 : 0; }

inline float GetGlobalTimeMultiplier() { return *g_globalTimeMultiplierPtr; }

inline float GetGameSettingFloat(GameSettingView *setting, float fallback = 0.0f) {
  return setting ? setting->data.f : fallback;
}

inline const char *GetGameSettingString(GameSettingView *setting) { return setting ? setting->data.str : nullptr; }

inline float GetIniMusicVolume() { return *g_iniMusicVolumePtr; }

inline void SetIniMusicVolume(float volume) { *g_iniMusicVolumePtr = volume; }

inline float GetHavokMaxTime() { return GetGameSettingFloat(g_fHavokMaxTimeSetting); }

inline float GetCombatItemRestoreTimer() { return GetGameSettingFloat(*g_fCombatItemRestoreTimerSettingPtr); }

inline float GetCombatItemBuffTimer() { return GetGameSettingFloat(*g_fCombatItemBuffTimerSettingPtr); }

inline const char *GetFullHealthMessage() { return GetGameSettingString(g_sFullHealthSetting); }

inline UINT32 *GetVoiceLipDistanceLimit() { return g_voiceLipDistanceLimitPtr; }

inline TileMenuArrayView *GetTileMenuArray() { return g_tileMenuArray; }

inline void *GetTextureManager() { return g_textureManager; }

inline void *GetPrimitivesEnabledSetting() { return g_primitivesEnabledSetting; }

inline void *GetHUDMainMenu() { return *g_hudMainMenuPtr; }

inline const char *GetCrosshairRefName() { return g_crosshairRefName; }

inline char *GetMutableCrosshairRefName() { return g_crosshairRefName; }

inline void *GetInventoryMenu() { return *g_inventoryMenuPtr; }

inline void *GetContainerMenu() { return *g_containerMenuPtr; }

inline void *GetContainerMenuSelection() { return *g_containerMenuSelectionPtr; }

inline void *GetBarterMenu() { return *g_barterMenuPtr; }

inline void *GetBarterMenuSelection() { return *g_barterMenuSelectionPtr; }

inline UINT32 GetBarterMenuSelectedTrait() { return *g_barterMenuTraitIsBarterSelectedPtr; }

inline void *GetRecipeMenu() { return *g_recipeMenuPtr; }

inline INT32 GetRecipeMenuCategory() { return *g_recipeMenuCategoryPtr; }

inline void *GetMapMenu() { return *g_mapMenuPtr; }

inline UINT32 GetMapMenuCurrentTabTrait() { return *g_mapMenuCurrentTabTraitPtr; }

inline UINT32 GetGameScreenHeight() { return *g_screenHeightPtr; }

inline void SetInDialogueOrHolotapePlaying(bool value) { *g_inDialogueOrHolotapePlayingPtr = value ? 1 : 0; }

inline bool IsMenuVisible(UINT32 menuType) { return g_menuVisibilityArray[menuType] != 0; }

inline void *GetDialogMenu() { return *g_dialogMenuPtr; }

inline bool IsDialogMenuOpen() { return *g_dialogMenuVisiblePtr; }

inline void *GetCurrentRadio() { return *g_currentRadioPtr; }

inline char *GetCurrentRadioSong() { return g_currentRadioSong; }

inline void *GetDynamicRadios() { return g_dynamicRadios; }

inline bool IsRadioEnabled() { return *g_radioEnabledPtr != 0; }

inline UINT32 VATSGetMode() { return *g_vatsModePtr; }

inline void *VATSGetMenu() { return *g_vatsMenuPtr; }

inline TESObjectREFR *VATSGetCurrentTarget() { return *g_vatsMenuCurrentTargetPtr; }

inline void *VATSGetRenderedTexture() { return *g_vatsRenderedTexturePtr; }

inline bool IsVATSActive() { return VATSGetMode() != 0; }
