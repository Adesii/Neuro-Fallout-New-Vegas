...
enum { kDeviceType_Keyboard = 1, kDeviceType_Mouse };
...
public:
  ...
  HRESULT ProcessBufferedData(IDirectInputDevice8 *device, DWORD dataSize, DIDEVICEOBJECTDATA *outData,
...
private:
  enum { kFrameTimeHistoryLength = 32 };
