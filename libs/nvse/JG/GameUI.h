...
public:
  ...
  static void InitGunScope(TESModel *apModel) { CdeclCall(0x709C20, apModel); }

  static void SetGunScopeVisible(bool abVisible) { CdeclCall(0x709C40, abVisible); }

  static void ClearGunScope() { CdeclCall(0x709CA0); }

  static bool IsLoadingMenuVisible() { return CdeclCall<bool>(0x705E80); }

  static uint32_t GetTopMenuID() { return CdeclCall<uint32_t>(0x7023C0); }
};
...
public:
  ...
  virtual void HandleMouseover(uint32_t arg0,
                               Tile *activeTile); //	Called on mouseover, activeTile is moused-over Tile
  ...
  static bool IsMenuVisible(Interface::Menus aeMenu) { return CdeclCall<bool>(0x7027B0, aeMenu); }
};
...
public:
  ...
  enum {
    ...
    kFlag_FreeContChangeOnListItemDestruction =
        2, // assumes the object is a ItemChange - do not set this if the object isn't one...
  };
  ...
  Tile *Insert(Item *item, const char *text,
               int32_t (*sortingFunction)(const ListBoxItem<Item> *&aItem1, const ListBoxItem<Item> *&aItem2) = nullptr,
...
public:
  ...
  static ItemChange *Selection() { return *reinterpret_cast<ItemChange **>(0x11D9EA8); }
};
...
public:
  ...
  static void SetHUDShake(float afShakePower) { CdeclCall(0x94C3A0, afShakePower); }
};
